...
def convert_asnamelist_to_b64blob(filein, fileout):
    """convert an asn + as-name list (one per line, space after ASN, 32bits with dots) to the compressed-based64-asnames-dictionary (readable by pyasn)"""
